...
export const loader = {
    loadIcon: () => loadBundle("sh_font_awesome_icon_picker_widget.assets_icon"),
};

export async function loadIcon() {
    try {
        await loader.loadIcon();
        return odoo.loader.modules.get("@sh_font_awesome_icon_picker_widget/components/icon_picker_popover/icon_picker_popover_data");
    } catch {
        return { icons: [] };
    }
}
...
export class IconPickerPopover extends Component {
    static template = "sh_font_awesome_icon_picker_widget.IconPickerPopover";
